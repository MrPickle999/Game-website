    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 max-w-7xl mx-auto w-full p-4 md:p-8 space-y-8">
        ...
        {!searchQuery && activeCategory === Category.ALL && (
          <section className="relative h-64 md:h-80 rounded-2xl overflow-hidden shadow-2xl">
            <img 
              src="https://picsum.photos/seed/banner/1200/400" 
              className="w-full h-full object-cover" 
              alt="Hero Banner"
            />
            <div className="absolute inset-0 bg-gradient-to-r from-slate-950 via-slate-900/60 to-transparent flex items-center p-8 md:p-12">
              <div className="max-w-md space-y-4">
                <span className="bg-indigo-600 px-3 py-1 rounded text-[10px] font-bold uppercase tracking-widest">Featured</span>
                ...
                <button 
                  ...
                  className="bg-white text-slate-900 px-8 py-3 rounded-full font-bold hover:bg-indigo-400 hover:text-white transition-all transform hover:scale-105 active:scale-95 shadow-xl"
                >
                  Play Now
                </button>
              </div>
        ...
        <section>
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-lg font-bold flex items-center gap-2">
              <i className="fas fa-th-large text-indigo-500"></i> Browse Categories
            </h3>
          </div>
        ...
        <section>
          ...
          {filteredGames.length > 0 ? (
            ...
            <div className="flex flex-col items-center justify-center py-20 bg-slate-800/20 rounded-2xl border border-dashed border-slate-700">
        ...
        {!searchQuery && activeCategory === Category.ALL && (
           <section className="bg-slate-900/50 rounded-2xl p-6 border border-slate-800">
             <div className="flex items-center justify-between mb-6">
               ...
               <a href="#" className="text-xs font-bold text-indigo-400 hover:underline uppercase tracking-widest">View All</a>
             </div>
             <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-8 gap-4">
               {hotGames.map((game) => (
                 ...
                 >
                   <div className="aspect-square rounded-2xl overflow-hidden mb-2 border border-slate-700 hover:border-indigo-500 transition-all">
      ...
      <footer className="glass-panel border-t border-slate-800 py-12 px-8 mt-12">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2 space-y-4">
             <div className="flex items-center gap-2">
              ...
              <h1 className="text-xl font-orbitron font-bold">NEXUS</h1>
            </div>
            <p className="text-slate-400 text-sm max-w-sm">
              Nexus Games provides the best curated selection of unblocked web games. Play 2048, Hextris, and hundreds of other titles without restrictions. High performance, zero lag, all fun.
            </p>
        ...
        <div className="max-w-7xl mx-auto mt-12 pt-8 border-t border-slate-800 text-center text-xs text-slate-500">
          © 2024 Nexus Games Unblocked. All Rights Reserved. Built with performance in mind.
        </div>
      </footer>
